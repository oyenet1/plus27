...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <button type="button" class="btn btn-sm btn-neutral"> <i class="fa fa-arrow-circle-left"
    ...
    <div class="container-fluid mt--6">
        ...
        <div class="row justify-content-center">
            <div class="col row">
                <div class="card col-lg-10 col-xl-8 justify-content-center col-lg-offset-1 col-xl-offset-2">
                    <form action="{{ route('book.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <fieldset class="m-2 p-2">
                            <legend class="pl-2 text-primary">Add Book</legend>
                            ...
                            <div class="form-group custom-file mb-3">
                                <input type="file" class="form-control custom-file-input" name="cover"
                                    value="{{ old('cover') }}"><label class="custom-file-label" for="customFile">Choose
                                    Book cover</label>
                                @error('cover')
                                    <small class="text-danger w-100 small"> {{ $message }} </small>
                                @enderror
